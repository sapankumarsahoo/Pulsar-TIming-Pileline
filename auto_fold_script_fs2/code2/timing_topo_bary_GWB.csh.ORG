...
if($#argv<12) then
    echo " "
    echo "Usage: timing.csh frequency_(MHz) [322 or 607] full_data_dir [/data/data/31_036_10dec2k16.2048.322.GHRSS] DM [38.000] Period [4.84] bin[32] backend[GSB/GHRSS_2K/GHRSS_1K/GWB] mode [ia/pa] scratchdir [/data/analysis/] zmax [0 or 200] numharm [8 or 16] dspsr [0 for both prepso-dspsr, 1 for only dspsr] raw_id[0-5]"
    echo "Exiting..... "
    exit
  endif
