...
#set output=/data/ankita/analysis/J1242-4712
set srcpath = "/data/ankita/scripts/code2/sources"
...
while ($i <= $numfile)
	...
	cd $scan
	#rm -rf *par *pfd*
	cp /data/ankita/analysis/J1242-4712/${scan}*par .
	...
	if ("$dedisp_type" == "I")then
		if ("$raw_id" == 0)then
			...
			#GPTool
		        ...
		        filterbank ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.gmrt_dat > ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.fil
	                ...
	                prepfold -timing *par ${scan}*fil -noxwin -o ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.new_freq.gptool
			...
			prepfold -timing *par ${scan}*fil -noxwin -o ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.${raw_id}.new_freq.gptool
	       		echo "Folding is complete for $scan" >> Time.log
		...
		#GPTool
		cp /data/ankita/scripts/header_files/gptool.${freq}MHz_${bandwidth}MHzBW_${nchan}channel.in gptool.in
                /data/jroy/softwares/gptool_ver4.2.1/gptool -f ${rawdir}/${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id} -o . -m 32 -nodedisp  -t 4
                ln -s ${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id}.gpt ${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id}.gmrt_dat
		...
		#filterbank ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.gmrt_dat > ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.fil
                ...
                python $code/convert_8_to_16bit.py $RAJ $DECJ ${rawdir}/${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id}.hdr ${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id}.fil
                cat ${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id}.gmrt_dat >> ${scan}_${freq}_${bandwidth}_bm2_${date}.raw${raw_id}.fil

                prepfold -n 512 -nsub 512 -timing ${scan}*par ${scan}*fil -noxwin -o ${scan}_${freq}_${bandwidth}_${nchan}.${date}.raw${raw_id}.new_freq.gptool
