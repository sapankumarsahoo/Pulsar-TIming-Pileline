...
$code/gmrt_hdr.timing_GWB_GPTOOL_FREQ_OFFSET_band2.csh $date $freq $rawdir $dedisp_type $mode $nchan $raw_id
...
while ($i <= $numfile)
	...
	if ("$dedisp_type" == "I")then
		if ("$raw_id" == 0)then
			...
			#GPTool
	                cp /data/ankita/scripts/header_files/gptool.${freq}MHz_${bandwidth}MHzBW_${nchan}channel_band2.in gptool.in
		...
		filterbank ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.gmrt_dat > ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.fil
                ...
                prepfold -n 64 -nsub 1024 -timing ${scan}*par ${scan}*fil -noxwin -o ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.new_freq.gptool
