...
#set output=/data/Sapan_grad_proj/J1207_data/3aug2k21/
...
while ($i <= $numfile)
	...
	cd $scan
	#rm -rf *par *pfd*
	cp /data/Sapan_grad_proj/J1207_data/3aug2k21/${scan}*par .
	...
	if ("$dedisp_type" == "I")then
		if ("$raw_id" == 0)then
			...
			#GPTool
	                cp /data/Sapan_grad_proj/scripts/header_files/gptool.${freq}MHz_${bandwidth}MHzBW_${nchan}channel.in gptool.in
		        ...
		        filterbank ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.gmrt_dat > ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.fil
	                ...
	                prepfold -timing *par ${scan}*fil -noxwin -o ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.new_freq.gptool -n 256
			...
			prepfold -timing *par ${scan}*fil -noxwin -o ${scan}_${mode}_${freq}_${bandwidth}_${nchan}_${int_factor}_1_8_${date}.raw.${raw_id}.new_freq.gptool -n 256
	       		echo "Folding is complete for $scan" >> Time.log
		...
		filterbank ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.gmrt_dat > ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.fil
                ...
                prepfold -n 512 -nsub 512 -timing ${scan}*par ${scan}*fil -noxwin -o ${scan}_${freq}_${bandwidth}_${nchan}_${int_factor}.${date}.raw${raw_id}.new_freq.gptool
